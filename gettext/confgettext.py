...
head =  "# KOReader PATH/TO/FILE.PO\n"
head += "# Copyright (C) 2005-" + strftime("%Y", time_now) + " KOReader Development Team\n"
head += "# FIRST AUTHOR <EMAIL@ADDRESS>, YEAR.\n"
head += "#\n"
head += "msgid \"\"\n"
head += "msgstr \"\"\n"
head += "\"Project-Id-Version: PACKAGE VERSION\\n\"\n"
head += "\"Report-Msgid-Bugs-To: https://github.com/koreader/koreader-base/issues\\n\"\n"
